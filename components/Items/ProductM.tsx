    ...
    <div className="w-full rounded-lg overflow-hidden">
        <div>
            <div className="w-full h-96 group overflow-hidden relative">
                <Link href={"/obs"}>
                <img
                  src={"https://media.kohlsimg.com/is/image/kohls/4305449?wid=805&amp;hei=805&amp;op_sharpen=1 1200w"}
                  alt="product image"
                  width={500}
                  height={500}
            ...
            <div className="border-[1px] border-slate-300 border-t-0 px-2 py-4 flex flex-col gap-y-2 bg-white rounded-b-lg">
                <p>Obsidian Ultrasonic Diffuser</p>
                <div className="flex items-center justify-between">
                    <div className="border-[1px] border-orange-600 py-1 px-4 rounded-full text-xs">
                        <p>15% off</p>
                    </div>
                    <div>
                        <p className="text-slate-500 line-through text-sm">$77</p>
